...
"""Inject Knowledge CI context for a code file before AI edits."""
...
HELP = "Inject knowledge context for a code file."
...
def build_parser(add_help: bool = True) -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Inject Knowledge CI context for a code file before AI edits.", add_help=add_help
    )
    parser.add_argument(
        "--file",
        required=True,
